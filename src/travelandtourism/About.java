...
public class About extends JFrame implements ActionListener {
    ...
    About(){
        ...
        String s = "About Projects               \n"+
                "The objective of the Travel and Tourism System project is to develop a System that automates the processes"+
                "and the purpose is to design a system using which one can perform all operation related to"+
                "traveling"+"\n"
                +"\n"+
